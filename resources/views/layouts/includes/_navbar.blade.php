<nav class="navbar navbar-default navbar-fixed-top">
    <div class="brand">
        <a href="/dashboardatk"><img src="{{asset('assets/img/canva-photo-editor3.png')}}" alt="Klorofil Logo"
    ...
    <div class="container-fluid">
        ...
        <div id="navbar-menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span>{{auth()->user()->name}}</span> <i
