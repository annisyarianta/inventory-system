...
@section('content')
    ...
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h2 mb-2 text-black-800" style="font-weight: 600">Daftar User Activity</h1>
        <br>
        <!-- DataTales Example -->
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting text-center" tabindex="0" aria-controls="dataTable"
                                                ...
                                                style="width: 50px;">Log Uri</th>
                                            <th class="sorting text-center" tabindex="0" aria-controls="dataTable"
                                                rowspan="1" colspan="1"
                                                aria-label="Created_at: activate to sort column ascending"
                                                style="width: 50px;">Log Metadata</th>

                                            <th class="sorting text-center" tabindex="0" aria-controls="dataTable"
                                                rowspan="1" colspan="1"
                                                aria-label="Created_at: activate to sort column ascending"
                                                style="width: 50px;">Log Method</th>
                                        </tr>
                                    </thead>
                                    <?php $no = 0; ?>
                                    @foreach ($logactivities as $row)
                                        <?php $no++; ?>
                                        <tr>
                                            <td scope="row" class="text-center"><?= $no ?></td>
                                            <td>{{ $row->log_date }}</td>
                                            <td class="text-center">{{ $row->log_uri }}</td>
                                            <td class="text-center">{{ $row->log_metadata }}</td>
                                            <td class="text-center">{{ $row->log_method }}</td>
                                        </tr>
                                    @endforeach
                                </table>
                            </div>
